...
const config = {
  apiKey: process.env.REACT_APP_API_KEY, // 'AIzaSyBXOEGf0Pwo750yCaVwfd6PXpNmWZnjAow',
  authDomain: process.env.REACT_APP_AUTH_DOMAIN, // 'react-starter-kit-317a4.firebaseapp.com',
  databaseURL: process.env.REACT_APP_DATABASE_URL, // 'https://react-starter-kit-317a4.firebaseio.com/',
};
